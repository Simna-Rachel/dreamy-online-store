...
<body>
    ...
    <nav class="navbar">
        <div class="logo">✦ DREAMY ✦</div>
            <ul class="nav-links">
            <li><a href="home.php" class="active"><i class="bi bi-house-heart"></i> Home</a></li>
    ...
    <header class="hero-section">
        <div class="hero-window">
            ...
            <div class="window-header">
                ...
                <span>storefront.exe</span>
            </div>
            <div class="hero-img-container">
                
                <div class="scanlines"></div> 
                <img src="./mod.jpg" alt="The Store" class="hero-img">
                
                <div class="hero-overlay-text">WELCOME TO THE DREAM</div>
            </div>
    ...
    <main class="container">
        ...
        <div class="product-grid">
            <?php
            // Using Category 2 for Home Featured (Bottoms)
            $query = "SELECT * FROM products WHERE category_id = 2 ORDER BY price ASC"; 
    ...
    <?php 
                ...
                echo "<p style='color: #E5A9E0; font-style: italic;'>No products available at the moment. Check back soon!</p>";
            }
            ?>
        </div>
    </main>
