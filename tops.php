...
<head>
    ...
    <title>Tops - Dreamy Y2K Shop</title>
    <link rel="icon" type="image/x-icon" href="favicon.ico">
    <link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
    <link rel="stylesheet" href="global.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <link rel="stylesheet" href="tops.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <div class="marquee">
        <div class="marquee-content">
            <span>✦ NEW TOPS DROPPED ✦ 20% OFF FIRST ORDER ✦ SECURE CHECKOUT ✦ NEW TOPS DROPPED ✦ 20% OFF FIRST ORDER ✦ SECURE CHECKOUT ✦</span>
            <span>✦ NEW TOPS DROPPED ✦ 20% OFF FIRST ORDER ✦ SECURE CHECKOUT ✦ NEW TOPS DROPPED ✦ 20% OFF FIRST ORDER ✦ SECURE CHECKOUT ✦</span>
        </div>
    </div>
    ...
    <nav class="navbar">
        <div class="logo">✦ DREAMY ✦</div>
            ...
            <li><a href="tops.php" class="active">Tops</a></li>
    ...
    <header class="category-header">
        <div class="category-window">
            <div class="window-header">
                ...
                <span>tops_collection.exe</span>
            </div>
            <div class="category-banner">
                <h1>NEW SEASON TOPS</h1>
            </div>
        </div>
    </header>
    ...
    <main class="container">
        <div class="product-grid">
            <?php
            // Fetching only Tops (category_id 1) and sorting by price
    ...
    <?php 
                ...
                echo "<p>No tops found in the database.</p>";
            }
            ?>
        </div>
    </main>
